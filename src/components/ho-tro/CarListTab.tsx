        ...
        <>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-4">
            <div className="flex items-center justify-between mb-3">
              <p className="text-xs font-bold text-gray-500 uppercase tracking-widest">
                Chọn trường dữ liệu ({checked.size}/{allFields.length})
              </p>
              ...
              {allFields.map(f => {
                ...
                return (
                  ...
                  >
                    ...
                    />
                    {FIELD_LABELS[f] ?? f}
                    {isDefault && <span className="opacity-60 text-[9px]">★</span>}
                  </label>
                )
              })}
            </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
            <div className="flex items-center justify-between px-5 py-3 border-b border-gray-100">
              ...
              <button
                onClick={exportExcel}
                className="flex items-center gap-2 px-4 py-1.5 bg-emerald-600 text-white text-xs font-medium rounded-lg hover:bg-emerald-700 transition"
              >
                📥 Xuất Excel
              </button>
            </div>
